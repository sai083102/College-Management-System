    ...
    <div className="overflow-x-hidden">
        ...
        <div className="home absolute top-32 mt-10 w-[50%] px-36">
          <div className="">
            ...
            In the tapestry of time, the current state of education weaves a complex and captivating narrative. Education, once confined to the walls of traditional classrooms, has now embarked on a journey of transformation and evolution. In the present epoch, education stands as a bridge connecting the realms of knowledge and aspiration, guiding curious minds towards enlightenment. It's a symphony of exploration, where students are no longer passive recipients, but active participants in their own learning odysseys.
            </p>
